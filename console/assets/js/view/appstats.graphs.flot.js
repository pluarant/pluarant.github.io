/******************/
	...
	function _flot() {
		...
		******************************************* **/
		...
		/* DAILY USERS */
		if (jQuery("#daily-users").length > 0) {
			...
			var plot = jQuery.plot(jQuery("#daily-users"), [d], options);
		}
		
		/* DAILY CONNECTIONS */
		if (jQuery("#daily-connection").length > 0) {
			...
			var plot = jQuery.plot(jQuery("#daily-connection"), [d], options);
		}
		
		/* DAILY MESSAGE */
		
		if (jQuery("#daily-message").length > 0) {
			...
			var plot = jQuery.plot(jQuery("#daily-message"), [d], options);
		}
		...
		******************************************* **/
		...
		/* MONTHLY USERS */
		if (jQuery("#monthly-users").length > 0) {
			...
			var plot = jQuery.plot(jQuery("#monthly-users"), [d], options);
		}
		
		/* monthly CONNECTIONS */
		if (jQuery("#monthly-connection").length > 0) {
			...
			var plot = jQuery.plot(jQuery("#monthly-connection"), [d], options);
		}
		
		/* monthly MESSAGE */
		
		if (jQuery("#monthly-message").length > 0) {
			...
			var plot = jQuery.plot(jQuery("#monthly-message"), [d], options);
		}
