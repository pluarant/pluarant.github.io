...
<!--=====================  added javascript code by dilip siresiya ===========================================================================-->
 //$(document).ready(function() {
		...
		if(window.width > 50) { /* changed by Tejas Shobhasana - 24 Oct 2016 - 768 to 50*/
			$(window).scroll(function() {
				if ($(document).scrollTop() > 1){  
					$('#header').addClass("fixed"); //changed by Tejas Shobhasana - 5 Nov 2016 -> sticky-header to fixed 
					$('#header').css({'-webkit-box-shadow' : ' 0 0 2px rgba(0,0,0,.1)', '-moz-box-shadow' : ' 0 0 2px rgba(0,0,0,.1)', 'box-shadow' : ' 0 0 2px rgba(0,0,0,.1)'});
					$('#topMain>li>a').css({ height:'60px', lineHeight:'38px'});
					$('#topNav a.logo').css({ height:'60px', lineHeight:'50px'});
					$('.logo>img').css({ height:'60px'});
					$('#page-menu').addClass("sticky-menu");
					$('#submenu').show();
				  }
				  else{
					$('#header').removeClass("fixed"); //changed by Tejas Shobhasana - 5 Nov 2016 -> sticky-header to fixed
					$('#header').css({ '-webkit-box-shadow' : 'none', '-moz-box-shadow' : 'none', 'box-shadow' : 'none'});
					$('#topMain>li>a').css({ height:'96px', lineHeight:'76px'});
					$('#topNav a.logo').css({ height:'96px', lineHeight:'96px'});
					$('.logo>img').css({ height:'80px'});
					$('#page-menu').removeClass("sticky-menu");
					$('#submenu').hide();
				  }
			});
		}
			...
			jQuery(window).scroll(function() {
				if(window.width > 50) { /* changed by Tejas Shobhasana - 24 Oct 2016 - 768 to 50*/
					...
					if(_scrollTop > _topBar_H) {
					   ...
					   //add by dilip siresiya(WD)
					  // $('.page-header').hide();
					  // $('.page-content').css({ paddingTop:'160px'});
